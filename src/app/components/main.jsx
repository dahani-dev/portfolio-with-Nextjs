...
const main = () => {
  return (
    <main className="bg-white dark:bg-[#18181B] px-10 flex justify-between gap-8">
      <div className=" flex-grow backdrop-blur-md bg-red-600 py-9 px-10 rounded-2xl min-w-[60%]">
        <h1 className="text-white font-semibold text-2xl mb-7">Services</h1>
        <div className="flex items-center justify-between gap-5 flex-wrap">
          <div className="flex-grow flex justify-between items-center gap-8 py-4 px-5 bg-white rounded-xl dark:bg-[#18181B] max-w-80">
            <div className="">
